...
class PythonAnalyzer(BaseLanguageAnalyzer):
    ...
    def analyze_file(self, file_path: Path, content: str, memory: MemoryIntelligence, global_memory: MemoryIntelligence) -> List[Dict[str, Any]]:
        ...
        for i, line in enumerate(lines):
            ...
            # IMPROVED: elif "import *" in line_stripped and "from" in line_stripped:
                issues.append({
                    "type": "code_quality",
                    "line": i + 1,
                    "severity": "medium",
            ...
            # IMPROVED: elif line_stripped == "except Exception as e:" or "except Exception as e:" in line_stripped:
                issues.append({
